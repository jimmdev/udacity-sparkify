...
songplay_table_drop = "DROP TABLE IF EXISTS songs_played"
...
songplay_table_create = ("""
    ...
    (start_time timestamp, user_id int, level varchar, song_id varchar, artist_id varchar, session_id varchar, location varchar, user_agent varchar);
""")
